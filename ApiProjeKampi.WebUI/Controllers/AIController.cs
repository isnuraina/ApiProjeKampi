        ...
        public async Task<IActionResult> CreateRecipeWithOpenAI(string prompt)
        {
            ...
            var requestData = new
            {
                ...
                messages = new[]
                {
                    ...
                    new {
                        role="system",
                        content="Sen bir restoran için yemek önerilerini yapan bir yapay zeka aracısın." +
                    "Amacımız kullanıcı tarafından girilen malzemelere göre tarifi önerisinde bulunmak. "
                    },
                    new {
                        role="user",
                        content=prompt
