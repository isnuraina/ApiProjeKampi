...
namespace ApiProjeKampi.WebApi.ValidationRules
{
    public class ProductValidator:AbstractValidator<Product>
    {
        public ProductValidator()
        {
            ...
            RuleFor(p=>p.Price).NotEmpty().WithMessage("Ürün fiyatı boş geçilemez!").LessThan(0).WithMessage("Ürün fiyatı negatif olamaz!")
                .GreaterThan(1000).WithMessage("Ürün fiyatı bu kadar yüksek olamaz,girdiğiniz değeri kontrol edin!");
